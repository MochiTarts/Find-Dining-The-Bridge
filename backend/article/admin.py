...
class ArticleAdmin(admin.ModelAdmin):
    ...
    list_filter = (TitleFilter, 'visibility', 'published', ('created_at',
                                                            DateFieldListFilter), ('modified_at', DateFieldListFilter))
    ...
    def publish_selected(self, request, queryset):
        ...
        if count > 1:
            messages.success(
                request, "Successfully published " + str(count) + " articles.")
        else:
            messages.success(
                request, "Successfully published " + str(count) + " article.")
    ...
    def unpublish_selected(self, request, queryset):
        ...
        if count > 1:
            messages.success(
                request, "Successfully unpublished " + str(count) + " articles.")
        else:
            messages.success(
                request, "Successfully published " + str(count) + " article.")

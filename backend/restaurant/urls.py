...
urlpatterns = [
    ...
    path('dish/pending/<int:user_id>/', views.PendingDishView.as_view(), name='pending_dish'),
    path('dish/pending/<int:user_id>/<str:dish_id>/', views.PendingDishView.as_view(), name='pending_dish_edit'),
    ...
    path('restaurant/draft/<int:user_id>/', views.RestaurantDraftView.as_view(), name='restaurant_draft_edit'),
    path('restaurant/submit/', views.RestaurantForApprovalView.as_view(), name='restaurant_for_approval'),
    path('restaurant/submit/<int:user_id>/', views.RestaurantForApprovalView.as_view(), name='restaurant_for_approval_edit'),
